...
Voici ci-dessous les instructions pour utiliser le serveur dédié au projet pour déployer vos API. Partout où il est indiqué e22002182, il s'agit de votre login ENT à utiliser.
...
Pour la connexion, ça se fait par SSH avec le login/mdp ENT : ssh e22002182@info-tpsi.univ-brest.fr.
...
Avec un projet https://gitlab-depinfo.univ-brest.fr/e22002182/apis, les images doivent par exemple être taggées :

    - gitlab-depinfo.univ-brest.fr:5050/e22002182/apis/student-api:v1.0.0

    - gitlab-depinfo.univ-brest.fr:5050/e22002182/apis/authentication-api:v1.0.0

    - gitlab-depinfo.univ-brest.fr:5050/e22002182/apis/message-api:v1.0.0

Voici les commandes :

docker image tag monimagelocale:montag gitlab-depinfo.univ-brest.fr:5050/e22002182/apis/student-api:v1.0.0 # pour tagger

puis : docker image push gitlab-depinfo.univ-brest.fr:5050/e22002182/apis/student-api:v1.0.0 # pour mettre en ligne sur le registry
