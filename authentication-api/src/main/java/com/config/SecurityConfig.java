...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:12020", "http://localhost:5173", "http://localhost:3000"));
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("API Authentication & Posters")
                        .version("1.0.0")
                        .description("API REST pour la gestion des utilisateurs et des posters"))
